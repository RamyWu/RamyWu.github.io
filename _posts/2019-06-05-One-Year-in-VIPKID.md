...
当时期待希望能让「 AI 落地到教育改变资源不均衡问题」，或是为让「人类老师能更专注给学生传播深层而有意义的知识」。当然，这在当时就是一种模糊的概念。自从来到这里之后，才体会到，真实做AI 的教育产品的感受。
...
举个例子，人在学语言和文字的时候，优先感知到的是基本层次范畴，学习空间词汇会比时间词汇更容易。大脑喜欢听故事，生活中有各种隐喻，体现在文化上，潜移默化在改变我们的习惯。而语言是承载文化和交流的工具，在国际化的时代，不同文化对同一个意象图示的理解和表达会出现明显的差异。

就这样，我靠读书和产品的积累而产生的兴趣使我来到了 VIPKID 做中国小孩的英语教育。
...
然后我回顾这一年我的工作范围。每个项目，从开始调研探索，到失败结束，再到新一轮探索试错....我总共经历了三轮以下过程：
...
只能在此基础上，通过外显的指标来拆分更细的过程数据，即靠 AI 得出许多课堂分析维度，如参与率、专注度、互动率等。而教学本身的评估，这是另一个大问题。

AI 在视觉和语音的辅助，也仅仅能帮产品和技术发现：在课堂的哪些节点的互动率高低。而学生行为好坏，如何定义「好坏」，这是很主观的。而我们无法靠机器发现更多深度的问题，比如：为什么学生听不懂，是老师不够表现力、还是课件内容设计问题，还是产品功能没考虑到的问题？是否发生了哪些不和谐的事件？这些都是需要早期大量思考的。

在生产内容的流程上，AI课和普通的在线直播课，也有非常大的差异。

比如：AI 课没有真人老师的控制下，如何设计让学生在AI 课的整体环节中是流畅的，无明显感知的 AI。尽可能让学生专注、理解、并完成不同类型的教学活动，能理解所有学习过程、包括：每种类型的题目设计、答题方式、提交逻辑、整个激励体系的设计、活动方式和互动反馈方式等。

里面的复杂逻辑也是盘综错杂，光是语音题目这种类型，就会有多种不同类型的技术和规则，以满足不同教学目标和用户场景。
...
读了一些论文和《终身幼儿园》、《教育神经科学》等书籍之后，我觉得自己不能轻而易举地靠「指标」来驱动产品功能的思考。当做的时间久了，看到的问题很多，我逐渐在总结自己平衡理想和显示的「产品原则」：
...
此外，近期阅读的《一九八四》以及《美丽新世界》两本反乌托邦的反讽小说带来的启发（恐惧）。确实，在商业的各项指标中，我们被干扰了太多，我们总是轻而易举地被「教育」和「同化」，如果我们有幸成为「教育他人的人」，希望给社会带来正面的价值，而不仅仅是商业价值。

也许未来我会担心，当我们都通过 AI 老师教我们内容，会像小说一样所有的场景都被限定，我们会成为被限定的机器人。于此，我会尽一切的努力不让它发生。
