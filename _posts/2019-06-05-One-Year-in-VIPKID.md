...
在思考 AI 教育产品收益问题，预期阶段收益和衡量指标是挺困难的。

首先，教育产品交付的不仅仅是产品本身的用户指标，还有教学效果指标。

和市面上大多在线教育产品一样，我们靠「完课率」和「课消量」来衡量整体的 AI 课产品效果。长周期的用户成绩提升效果难以监控，回收数据太漫长，也无法确定学生是否受到其他影响。

我们只能在此基础上，通过外显的指标来拆分更细的过程数据指标。目前能实现在 AI 技术（如视觉、语音、NLP）等辅助下，得出许多课堂分析维度，如参与率、专注度、互动率等。虽然，这些也仅仅只能帮产品经理发现：在课堂的哪些节点的互动率高低，从而倒推问题是什么。但是，从教学目标来看，这些数据背后是否定义了学生行为的好坏，如何定义「行为好坏」是很主观的，如学生大部分是面无表情地望着屏幕，究竟是没听懂还是正在思考？

我们无法靠 AI 发现更多深度的问题，这些都是需要看课和挖掘大量数据长期积累和思考的问题。比如：为什么学生听不懂？-- 是老师不够表现力、表达不够感性和逻辑？是课件内容设计问题，还是产品功能没考虑到的问题？

而教学质量和学生接受度等学习效果评估，这是另一个大问题。（emm...这个问题本身就很困难的原因在书里和论文提到，补）


在 AI 课的落地阶段，最困难的起点在于内容生产的流程上。AI 课和已有的在线直播课有非常大的差异。

最开始大家做在线直播的业务框架，学生上课背后的内容系统和行为判断，都是靠真人老师控场。老师在学生不懂的时候会多次引导，而学生的学习行为结果、操作结果大多也是由老师来主观判断。学生在一节课所学到的内容，学生是否理解，很多并没有办法通过数据完整保留下来。

而在历史的业务平台上面来打造 AI 课，就会出现在古代的黄泥路开汽车一样的情况，道路结构本身就导致很多问题不兼容的情况。

我在设计这整个教室框架的时候，不仅需要打通各个路径的数据传输、让新型非自动化的生产流程结构选择现有成本最低的方案快速落地。早期探索失败了几次，首先学生的整体体验很差，能满足的教学场景单一。难度不仅在于 AI 课的录播老师很难实时反馈；而学生在没有真人老师的控制下，许多行为光靠 AI 的人脸和语音检测是远远不够的。这也让产品出现很难定义问题。以及，如果一节课的内容生产效率太低也会影响质量和交付时间。

在后来的设计，就开始吸取历史教训：

1、考虑更多教学场景，尽可能让学生专注、理解、并完成不同类型的教学活动，能理解所有学习过程、包括：每种类型的题目设计、答题方式、提交逻辑、整个激励体系的设计、活动方式和互动反馈方式等。
2、同时让 AI 老师在上课的过程中，需要老师理解他和 AI 助教结合互动的过程，这样才不会让课堂画面出现违和感，这也突破了传统的教学模式和上课规则。
3、然后通过现有的技术架构来结合产品方案，打通公司现有业务逻辑，切换新的设计思路。让一节 AI 课在整体各环节能自行运转，并让学生在课程体验是流畅的，这个需要更具有拓展性的内容生产系统结合在一起，才能让一节课既有质量，又不增加教研负担。


上面的这个例子，已经看到一节看似简单的 AI课的背后是复杂的业务逻辑，而光是 AI 语音题目，就会有多种不同类型的技术和规则，以满足不同教学目标和用户场景。儿童语音识别现在还没有彻底突破技术难点。这是AI课里面非常痛的问题。

产品的各项功能都有它独立的衡量方式，不断打磨教学产品体验来靠近预期的互动率、完课率、复购率等指标。
...
而在产品思考层面，也许和许多人观点不一样，我是优先考虑教学意义和学习效果，而后考虑产品表面数据指标的。因为，从语言本身的特殊性分为外显和内隐。

> 语言作为人类的交际工具：首先是外显性的，易于观察，能产生一些观察数据，可以通过数据来评定语言的功能发挥程度。同时，语言又是内隐性的作为思维工具，不易观察。不易产得到观察数据。-- 《论语言的功能分类》李宇明

读了一些论文和《终身幼儿园》、《教育神经科学》等书籍之后，我觉得自己不能轻而易举地靠「指标」来驱动产品功能的思考。（emm...为什么这么说，现在在公司，待会这里补个书里面提到的观点）当做的时间久了，看到的问题很多，我逐渐在总结自己平衡理想和显示的「产品原则」：
