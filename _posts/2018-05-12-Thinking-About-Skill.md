...
个人觉得，优秀的产品经理都需要掌握底层的思维模型（高阶模型），但不是在当前阶段必须掌握的技能。但是必须从现在就开始不断积累的知识，因为太庞大了，无法一下就学到位。

而且产品经理会不断成长，越往后所接手的项目也会越来越大，需要做出较难的决策与判断。决策依据除了来源于经验的直觉判断以外，就需要有一定的底层思维模型，来统领我们的方法论。这需要将底层理论运用于工作中，并持续积累和思考。
