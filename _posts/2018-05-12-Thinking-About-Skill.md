...
我们为什么会焦虑，原因在于无法控制周围的环境。而如何控制周围的环境，首先应该控制自我，并根据当前问题，寻找解决方案，在学习和行动中不断提升自我。

在2015~2018这三年半，工作中时常磕磕碰碰，从最初的没有任何「悟性」到搜索各种自我提升的方法，最终我意识到自己工作中最大的几个问题在于以下技能不达标：
...
- 最后是进阶技能，进阶技能决定了一个人未来能走多远，思考层次有多深，对周围环境的控制越来越大等。不仅需要依赖实战，更需要高阶模型来指导自己的思维框架，以及源头的知识来扩展自己的认知边界。进阶技能需要持续十年以上的阅读与输出的积累，短期内不会有很大的成效。
...
- 其次，沟通的形式，最重要的不是选择邮件沟通还是线下沟通，背后应该是正确的沟通方式。比如你是否清晰并准确地描述了你的问题；是否草拟了一份对该问题的解决方案abc 来让沟通对象进行选择和修改；是否是否经历过探索，并描述自己探索时遇到的具体困难有哪些；需要获取当前阶段的学习帮助是什么，包括学习方法、推荐资料和建议等；沟通不是理直气壮地把需求传达给别人让别人帮你做，而是站在双方的角度，更好地将事情推动下去。这里推荐阅读：[提问的智慧](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/blob/master/README-zh_CN.md)、[caoz的梦呓-从校园到职场-系列文章](https://mp.weixin.qq.com/s/cvof5hcA7ey60tt_XfaGGw)
...
虽然在当前阶段不需要立刻掌握这些进阶技能，但是必须从现在就开始不断积累。因为进阶技能所需要的背景知识太庞大了，无法一下就学到位。慢慢探索中...不断提升自己，

我自己对学习技能的时间分配：80%用来投入到工作中练习专业技能，并根据实际产出项目的经验，输出自己的思考总结。剩余的20%，用来学习方法论、练习基础技能，阅读各种源头知识，并将它们用到工作中、生活中。
