...
而上面的几个方向，可以从认知框架的角度讲现在的AI技术，分为两大类：感知智能，和认知智能。（图1来源于-人工智能的现状与未来）
...
2、而作文评分是目前教育行业里，运用到 NLP 技术较多的场景，而作文批改比评分要更难。而在批改里面主要以智能校对做为核心基础。最早做校对的黑马校对，用于出版社编辑较多。
