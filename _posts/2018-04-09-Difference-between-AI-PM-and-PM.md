...
在说区别之前，先看一下有哪几类不同的 AI 公司，以及 AI 公司下有哪几类不同的 AI PM？
...
先说 PM 们相同的地方，不论是什么岗位的 PM，都需要从「用户」「需求」「场景」等角度出发来确定一款产品。在产品的不同阶段，比如需求分析、产品功能设计、进入研发阶段来说，AI PM 和 PM 之间也会交叉或重合的地方。


从产品定位和产品形态来说，总体分为 toB 和 toC的公司或业务：

- 如果是 toB 的 PM，就需要基于目标客户的场景和需求，制定解决方案或系统业务，产品形态可以是提供相应的 API 或 SDK；
- 如果是 toC 的 PM，就是自己对所负责模块的功能，根据需求场景，做完整个流程和功能设计，将目标拆解和落地，梳理清楚各个逻辑，写产品设计文档，交付团队的UI设计师、工程师，包括移动端（前端）和后端...

那么 PM 的通用技能有哪些？我参考了下篇文章，[Product Manager Skills By Seniority Level — A Deep Breakdown](https://medium.com/pminsider/product-manager-skills-by-seniority-level-a-deep-breakdown-cd0690f76d10)

简单翻译下，就是：

1. 战略思维：能为越来越大的产品领域和问题寻找答案
2. 沟通能力：书面和口头交流可以表达清晰准确
3. 合作能力：在团队内部和外部协作下，完成任务
4. 利用工具：利用产品管理工具，在团队中可以有统一良好的合作方式
5. 把控细节和质量：推动项目进展结果，并发现细节错误
6. 用户科学与同理心：用用户科学的工具，理解用户，产品能适应用户行为和需求
7. 管理能力：管理团队组织的成长，对人员的管理

## AI PM


上面根据不同行业和方向，对 AI 公司还做了一个分类，那么这几种分类下的 AI 产品经理，又有什么不同呢？


~ 看到大家都在说，AI PM 除了理解技术还需要懂点算法原理，在功能设计时需要考虑底层算法的能力范围，...但是，技术理解要到什么层次？所有的 AI PM 都需要学算法和技术吗？
...
【行业+AI】的这类公司，其中一部分业务流程种的某一个模块必须要用到 AI技术，比如：

- faceU、各视频直播使用的AR服务，对人脸识别服务，关键点定位，开发人脸贴纸特效
- 某些金融产品的支付模块使用的身份验证服务...
- ...也许不久后就会有更多模块和流程都能 AI 实现了。

产品使用的 AI 服务基本都是与【基础层 AI】公司合作来解决自己的行业需求，这些功能也许早就存在，但是以前是基于人工或者是用传统技术来解决，而如今随着某些领域（如计算机视觉）的 AI 技术成熟，许多功能底层用 AI 更高效、更精确。
...
举我自身的例子，写匠的核心竞争力在 AI + NLP 上，首先，该场景的特殊的功能需求，第三方提供的通用服务无法解决该行业的问题；其次，核心竞争力所依靠的技术壁垒还得自己打下来，不论门槛多高或者是技术资源不足，都需要靠自己来研发了，这类公司的 AI PM 要学习的东西就很多了！！如果是 NLP 方向的话，可能还得再多了解语言相关基础常识。

所以这类 AI PM 既要了解产品本身的核心应用场景、用户需求，做出更接近用户行为的产品设计，又要思考算法技术提供的能力范围，如何无缝衔接到产品的核心功能里，如果算法能力明显跟不上用户需求，那这款产品给用户带来是帮助，还是浪费用户的时间？比如写匠的校对功能主要攻破算法问题：
...
然后，如何提升这些指标？如何拆解需求？如何抽象出各种语言规则？算法的输入和输出？算法评测对比？数据如何显示？前后端业务逻辑拆分？前端交互设计？版本迭代哪些功能？...

不仅融合了产品的各个层级，也需要 AI PM 的里里外外的全程参与，整个团队都要花很大功夫去思考，并且团队最好要有该领域专家来做知识的制定和补充。
...
发现不论 toB 还是 toC，不论是不是 AI 产品，其实最终都是为了解决问题，解决用户在特定场景中的特定需求，解决他们在这些场景种更重要的问题、他们更关心的问题。

虽然 AI PM 也有不同的方向和轨迹，但是很多地方的基本原则是一致的，思维方式其实很多共通的，比如从用户需求场景出发，解决各种问题也是从需求出发，使用通用的产品设计思维，用这些通用原则来思考，把无边无际的问题和答案约束在一个范围区间，把精力集中在最重要的问题，最核心问题上。

而在解决问题的过程中，如果 PM 必须用 AI 解决的，就去看更多的资料，找更多的资源、数据来支撑业务的发展。


那么再看看，这几类产品经理，每天要解决的核心问题是什么，每天都在思考什么问题，重心时间都花在哪里，大概就能感知到他们之间的差异了。


~ 有效关注重要的事，这样会帮助自己，带着整个团队一起走下去，而不是迷失。
