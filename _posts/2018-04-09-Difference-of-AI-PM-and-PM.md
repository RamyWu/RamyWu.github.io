...
记得最开始朋友问我这个问题的时候，我说我没坐过常规PM，一上来就做AI PM了，...当时我并不知道怎么回答。如今 AI 快速发展的今天，自己不知不觉也呆了快 3 年了，历经了计算机视觉（CV）和 自然语言处理（NLP）两个领域，也做过 toB 和 toC 产品。总算有点不一样的体会，可以回答出好朋友的这个问题。
